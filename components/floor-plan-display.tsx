...
export function FloorPlanDisplay({ floorPlan, projectName }: FloorPlanDisplayProps) {
  ...
  const imageUrl = floorPlan.image_url
  const generatedBy = floorPlan.generated_by
  const createdAt = floorPlan.created_at
              ...
              <TabsContent value="description" className="mt-4 space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Badge variant="outline" className="bg-slate-700 text-teal-400 border-teal-500">
                    Generated by {generatedBy === "gemini" ? "Gemini AI" : "Groq AI"}
                  </Badge>
